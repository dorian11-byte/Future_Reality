...
<body>
<div class="container-fluid navbar navbar-light" style="background-color: #5EA6B8;">
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="/index.html">
            ...
            <form class="d-flex" action=""> 
                <a class="nav-link" href="index.html" style="color: #2f3640;">Regresar al Inicio <i class="fas fa-undo-alt"></i></a>
            </form>
          </div>
        </div>
      </nav>
